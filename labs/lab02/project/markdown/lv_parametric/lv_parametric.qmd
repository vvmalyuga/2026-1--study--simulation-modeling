...
```{julia}
param_grid = Dict(
    :x0 => 40.0,           # убираем вектор
    :y0 => 9.0,            # убираем вектор
    :α => [0.05, 0.1, 0.15, 0.2],
    :β => 0.02,            # убираем вектор
    :δ => 0.01,            # убираем вектор
    :γ => [0.2, 0.3, 0.4],
    :tspan => (0.0, 200.0), # убираем вектор
    :solver => Tsit5(),     # убираем вектор
    :saveat => 0.5,         # убираем вектор
