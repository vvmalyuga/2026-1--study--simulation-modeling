...
#
# **Цель:** определить, как интенсивность перемещения людей между городами
# влияет на скорость распространения эпидемии (время достижения пика) и
# масштаб пика. Инфекция начинается только в одном городе, остальные
# изначально здоровы.
#
# #### Параметры
#
# - `migration_intensity` – от 0 (нет миграции) до 0.5 (высокая мобильность).
#   Вероятность остаться в городе = 1 - intensity, вероятность переехать в
#   любой другой город = intensity/(C-1).
# - Для каждого значения интенсивности делается 3 прогона с разными seed.
#
# #### Ожидаемые результаты
#
# - При нулевой миграции эпидемия остаётся в первом городе.
# - С ростом миграции время до пика уменьшается, а высота пика увеличивается.
# - График показывает, как мобильность населения ускоряет межгородское распространение.
